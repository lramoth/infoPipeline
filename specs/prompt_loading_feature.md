...
- The Writer uses the contents of its initialized markdown file when it generates the Telegram brief
...
- The following folder 'prompts/writers/' contains a blank prompt for now called 'telegram_brief.md'
